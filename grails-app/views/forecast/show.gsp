...
<html>
    ...
    <body>
        ...
        <div id="show-forecast" class="content scaffold-show" role="main">
            ...
            <f:display bean="forecast" />
            <g:form resource="${this.forecast}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.forecast}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
